...
<div class="page-header">
    <div class="page-nav">
        ...
        <a href="{{ route('supervisor.attendance.show', 1) }}" class="btn-secondary">
...
<div class="form-container">
    <form class="attendance-form" action="{{ route('supervisor.attendance.update', $attendance->id) }}" method="POST">
            @csrf
    @method('PUT')
    <input type="hidden" id="user_id" name="user_id" value="{{ $attendance->user->id }}">
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('supervisor.attendance.show', $attendance->id) }}" class="btn-cancel">
                Cancel Changes
            </a>
