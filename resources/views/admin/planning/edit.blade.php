    ...
    <form action="{{ route('admin.planning.update', 1) }}" method="POST" class="planning-form">
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="current_team_size">Current Team Size</label>
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="risks">Updated Risk Assessment</label>
                ...
                <div class="form-group">
                    <label for="success_criteria">Success Criteria Updates</label>
