...
@section('title', 'Apply for Document - ' . env('COMPANY_NAME', 'Teqin Vally'))
...
<div class="page-header">
    ...
    <p>Submit a document request for approval</p>
</div>

<div class="form-container">
    <form action="{{ route('employee.documents.store') }}" method="POST" enctype="multipart/form-data" class="leave-form">
        @csrf
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" required>
                        ...
                        <option value="id_letter">ID Letter</option>
