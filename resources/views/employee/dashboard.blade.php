@extends('layouts.employee')
    ...
    @endphp
@section('title', __('messages.Employee Dashboard'))
@section('page-title', __('messages.Employee Dashboard'))

@section('content')
<!-- Quick Actions - Moved to Top for Better UX -->
<div class="quick-actions-top">
    <h2>{{ __('messages.Welcome User', [
            'name' => auth()->user()->name,
...
<div class="quick-actions-top">
    <div class="quick-actions">
        <a href="/employee/attendance" class="action-btn">
            <h4>{{ __('messages.Attendance') }}</h4>
        </a>
        <a href="#" class="action-btn" style="display:none">
            <h4>{{ __('messages.My Projects') }}</h4>
        </a>
        <a href="/employee/leaves" class="action-btn">
            <h4>{{ __('messages.Leave Management') }}</h4>
        </a>
        <a href="/employee/loans" class="action-btn">
            <h4>{{ __('messages.Loan Management') }}</h4>
        </a>
        <a href="/employee/trainings" class="action-btn">
            <h4>{{ __('messages.Training') }}</h4>
        </a>
    </div>
</div>
...
<div class="kpi-grid">
    <div class="kpi-card employees">
        ...
        <div class="kpi-content">
            ...
            <p>{{ __('messages.Assigned Projects') }}</p>
        </div>
    </div>
    ...
    <div class="kpi-card projects">
        ...
        <div class="kpi-content">
            ...
            <p>{{ __('messages.Attendance Today') }}</p>
        </div>
    </div>
    ...
    <div class="kpi-card attendance">
        ...
        <div class="kpi-content">
            ...
            <p>{{ __('messages.Leave Requests') }}</p>
        </div>
    </div>
