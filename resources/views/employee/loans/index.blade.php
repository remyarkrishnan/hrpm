        ...
        <table class="leave-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="leave-type">₹{{ $loan->amount }}</span>
                    </td>
                    <td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('employee.loans.show', $loan->id) }}" class="btn-action">
                                <i class="material-icons">visibility</i>
                            </a>
                            @if($loan->status === 'pending')
                       
                                <button class="btn-action btn-reject" onclick="deleteLoan({{ $loan->id }})">
