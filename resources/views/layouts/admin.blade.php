...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <!-- HR Management Section - Based on SRS Module 1 -->
            <div class="nav-section">
                <div class="nav-section-title">{{ __('messages.HR Management') }}</div>

                <!-- Employee Management (Implemented) -->
                <a href="{{ route('admin.users.index') }}" class="nav-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                    <i class="material-icons">people</i>
                    <span>{{ __('messages.Employee Management') }}</span>
                </a>
                ...
                <a href="{{ route('admin.leaves.index') }}" class="nav-item {{ request()->routeIs('admin.leaves.*') ? 'active' : '' }}">
                    ...
                    <span>{{ __('messages.Leave Management') }}</span>
                </a>
            ...
            <!-- Project Management Section - Based on SRS Module 2 -->
            <div class="nav-section">
                <div class="nav-section-title">{{ __('messages.Project Management') }}</div>

                <!-- Project Creation (SRS 5.1) -->
            ...
            <div class="nav-section" >
                ...
                <a style="display:none" href="{{ route('admin.hr-reports.index') }}" class="nav-item {{ request()->routeIs('admin.hr-reports.*') ? 'active' : '' }}">
                    ...
                    <span>{{ __('messages.HR Reports') }}</span>
                </a>
                ...
                <a href="{{ route('admin.project-reports.index') }}" class="nav-item {{ request()->routeIs('admin.project-reports.*') ? 'active' : '' }}">
                    ...
                    <span>{{ __('messages.Project Reports') }}</span>
                </a>
            </div>
            ...
            <div class="nav-section" >
                ...
                <a style="display:none" href="{{ route('admin.settings.index') }}" class="nav-item {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
                    ...
                    <span>{{ __('messages.System Settings') }}</span>
                </a>
            </div>
        </div>
