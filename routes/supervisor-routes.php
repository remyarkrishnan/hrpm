...
//use App\Http\Controllers\Manager\LoanController;
//use App\Http\Controllers\Manager\TrainingController;
//use App\Http\Controllers\Manager\DocumentController;
use App\Http\Controllers\Supervisor\OvertimeController;
use App\Http\Controllers\Supervisor\ShiftController;
use App\Http\Controllers\Supervisor\ApprovalController;
use App\Http\Controllers\Supervisor\PlanningController;
use App\Http\Controllers\Supervisor\ResourceController;
...
Route::middleware(['auth'])->prefix('supervisor')->name('supervisor.')->group(function () {
    ...
    Route::get('/approvals/leave/{id}', [ApprovalController::class, 'viewLeave'])->name('approvals.viewLeave');
    Route::get('/approvals/loan/{id}', [ApprovalController::class, 'viewLoan'])->name('approvals.viewLoan');
    Route::get('/approvals/training/{id}', [ApprovalController::class, 'viewTraining'])->name('approvals.viewTraining');
    Route::get('/approvals/document/{id}', [ApprovalController::class, 'viewDocument'])->name('approvals.viewDocument');
...
Route::prefix('api/mobile')->middleware(['auth:sanctum'])->group(function () {
    ...
    // Employee Info API
    Route::get('manager/profile', [UserController::class, 'mobileProfile'])->name('api.employee.profile');
    Route::get('manager/shifts', [ShiftController::class, 'mobileShifts'])->name('api.employee.shifts');
